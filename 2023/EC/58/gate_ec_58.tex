...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{figs/gatefig.png}
    \caption{Figure}
    \label{fig:graph}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/gate_x1.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/gate_x2.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{figs/gate_y.png}
