...
\hfill (GATE EE 2023)\\
\solution
\input{2023/EE/12/main.tex}
\newpage

In the following block diagram, $R\brak{s}$ and $D\brak{s}$ are two inputs. The output Y(s) is expressed as $Y\brak{s} = G_1\brak{s}R\brak{s} + G_2\brak{s}D\brak{s}$\\
