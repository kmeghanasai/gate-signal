...
\item A fresh catalyst is loaded into a reactor before the start of the following catalytic reaction:
 \begin{align*}
...
\text{(A) } x(t) \text{ tends to be an impulse as } $W_0$ $\rightarrow \infty$.

\text{(B) } x(0) \text{ decreases as } $W_0$ \text{ increases.}

\text{(C) At } t = $\frac{\pi}{2W_0}$, \quad x(t) = -$\frac{1}{\pi}$.

\text{(D) At } t = $\frac{\pi}{2W_0}$, \quad x(t) = $\frac{1}{\pi}$.
